...
export const UNKNOWN = "Unknown User";
export const IMAGE_PROXY = (url: string) =>
  `https://apoqrsgtqq.cloudimg.io/${url}`;

// data Sticker lay tu github
export const STICKERS_URL =
  "https://cdn.jsdelivr.net/gh/nguazzz/zalo-stickers/data/favourite.json";

//data file icons lay tu github
export const FILE_ICON = (extension: string) =>
  `https://cdn.jsdelivr.net/gh/nguazzz/file-icons/file/${extension}.svg`;
