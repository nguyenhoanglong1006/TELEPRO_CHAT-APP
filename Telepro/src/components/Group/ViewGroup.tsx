  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="border-lighten flex items-stretch border-b">
          <button
            onClick={() => setSelectedSection(Sections.members)}
            className={`text-dark-lighten flex-1 py-2 text-center ${
              selectedSection === Sections.members ? "bg-lighten" : ""
            }`}
          >
            Members
          </button>
          <button
            ...
            className={`text-dark-lighten flex-1 py-2 text-center ${
              selectedSection === Sections.admins ? "bg-lighten" : ""
            }`}
          >
            Admins
          </button>
          <button
            ...
            className={`text-dark-lighten flex-1 py-2 text-center ${
              selectedSection === Sections.addMembers ? "bg-lighten" : ""
            }`}
          >
            Add members
          </button>
