  ...
  return (
    <div id={`message-${message.id}`}>
      ...
      <div
        ...
        className={`group relative  flex flex-row-reverse items-stretch gap-2 text-ellipsis break-all px-8 ${
      ...
      >
        {message.type === "text" ? (
          <>
            {EMOJI_REGEX.test(message.content) ? (
              <div
                ...
                title={formattedDate}
                className="text-ellipsis break-all text-4xl"
              >
                {message.content}
              </div>
            ) : (
          ...
          <>
            <img
              ...
              title={formattedDate}
              className="max-w-[60%] cursor-pointer rounded-lg transition duration-300 hover:brightness-[85%]"
              src={message.content}
              alt=""
            />
            <ImageView
        ...
        {message.type !== "removed" && (
          <>
            ...
            >
              <i className="bx bx-reply text-2xl"></i>
            </button>
