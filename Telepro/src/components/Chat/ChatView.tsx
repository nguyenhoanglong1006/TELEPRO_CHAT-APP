...
const ChatView: FC<ChatViewProps> = ({
  ...
  if (loading)
    return (
      <div className="bg-lighten flex flex-grow items-center justify-center">
        <Spin />
      </div>
    );
  ...
  if (error)
    return (
      <div className="bg-lighten flex-grow">
  ...
  if (data?.empty)
    return (
      <div className=" flex-grow items-center bg-[url('/chat.gif')]">
        <p className="border-lighten text-dark mt-20 rounded-lg text-center text-4xl font-bold">
          No message recently
        </p>
      </div>
    );
  ...
  return (
    ...
    >
      <div className="flex flex-col items-stretch gap-3 bg-[url('/background.jpg')] pt-10 pb-1">
        {data?.docs
