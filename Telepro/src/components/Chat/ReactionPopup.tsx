...
// Pop-up cua reaction khi chon chuc nang tren message
const ReactionPopup: FC<ReactionPopupProps> = ({
  ...
  return (
    <div
      ref={forwardedRef}
      className={`bg-light animate-fade-in absolute bottom-[calc(100%+5px)] z-[1] flex gap-1 rounded-full p-[6px] shadow ${
